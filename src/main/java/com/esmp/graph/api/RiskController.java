...
/**
 * REST controller for structural risk analysis endpoints.
 *
 * <p>Exposes 2 endpoints:
 * <ol>
 *   <li>GET /api/risk/heatmap — list all JavaClass nodes sorted by descending structural risk
 *       score, with optional filtering by module, packageName, and stereotype
...
public class RiskController {
  ...
  /**
   * Returns all JavaClass nodes sorted by descending structural risk score.
   *
   * <p>Optional query parameters narrow the result set:
   * <ul>
   ...
   * @return 200 with list of {@link RiskHeatmapEntry} sorted by descending structuralRiskScore
   */
  @GetMapping("/heatmap")
  public ResponseEntity<List<RiskHeatmapEntry>> getHeatmap(
    ...
    List<RiskHeatmapEntry> entries = riskService.getHeatmap(module, packageName, stereotype, limit);
